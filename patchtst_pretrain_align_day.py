...
parser.add_argument('--dset_pretrain', type=str, default='stock_pretrain_align_day', help='dataset name')
parser.add_argument('--context_points', type=int, default=120, help='sequence length')
parser.add_argument('--target_points', type=int, default=5, help='forecast horizon')
