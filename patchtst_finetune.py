...
parser.add_argument('--dset_finetune', type=str, default='stock_finetune', help='dataset name')
...
if __name__ == '__main__':
    args.pretrained_model = '/home/userroot/dev/zms/saved_models/stock_pretrain/masked_patchtst/based_model/patchtst_pretrained_cw96_patch3_stride3_epochs-pretrain100_mask0.4_model1.pth'
