...
parser.add_argument('--dset_finetune', type=str, default='stock_finetune_align_day', help='dataset name')
parser.add_argument('--context_points', type=int, default=120, help='sequence length')
...
parser.add_argument('--stride', type=int, default=3, help='stride between patch')
# RevIN
...
if __name__ == '__main__':
    args.pretrained_model = '/home/userroot/dev/zms/saved_models/stock_pretrain_align_day/masked_patchtst/based_model/patchtst_pretrained_cw120_patch3_stride3_epochs-pretrain100_mask0.4_model1.pth'
    #'/home/userroot/dev/zms/saved_models/stock_pretrain_align_day/masked_patchtst/based_model/patchtst_pretrained_cw30_patch3_stride3_epochs-pretrain100_mask0.4_model1.pth'
