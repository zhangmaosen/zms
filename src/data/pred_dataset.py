...
class Dataset_Pred(Dataset):
    def __init__(self, root_path, split='pred', size=None,
                 features='M', data_path='etl/index_300_test/sz300750.csv',
...
class Predict_Stock(Dataset):
    def __init__(self, root_path, split='predict', size=None,
                 features='M', data_path='etl/index_300_test/sz300750.csv',
        ...
        self.file = os.path.join(self.root_path,
                                          self.data_path)
        self.use_time_features = use_time_features
    ...
    def __read_data__(self):
        ...
        border1 = 0 #border1s[self.set_type]
        border2 = len(df_data) #border2s[self.set_type]
    ...
    def __getitem__(self, index):
        ...
        if self.use_time_features: return _torch(seq_x, None, seq_x_mark, None)
        else: return _torch(seq_x, np.ndarray(0))
