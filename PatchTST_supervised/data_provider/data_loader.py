...
class Dataset_Stock(Dataset):
    def __init__(self, file, split='train', size=None,
                 features='M', 
                 target='OT', scale=True, timeenc=1, freq='b', use_time_features=False, train_split=0.7, test_split=0.2) -> None:
    ...
    def __read_data__(self):
        ...
        if self.features == 'M' or self.features == 'MS':
            start_id = 2 + 768*2 
            cols_data = df_raw.columns[start_id:] # ignore date code_idx column and embeddings
        ...
        emb_start_at = 2
        emb_end_at = 2+768*2
        emb_columns = df_raw.columns[emb_start_at:emb_end_at]
        ...
        self.data_x_emb = df_embeddings[border1:border2]
        self.data_y_emb = df_embeddings[border1:border2]
    ...
    def __getitem__(self, index):
        ...
        seq_x_emb = self.data_x_emb[s_begin:s_end]
        seq_y_emb = self.data_y_emb[r_begin:r_end]
        ...
        if self.use_time_features: return (seq_x, seq_y, seq_x_mark, seq_y_mark, seq_x_emb, seq_y_emb) # _torch(seq_x, seq_y, seq_x_mark, seq_y_mark, seq_x_emb, seq_y_emb)
